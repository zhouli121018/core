<template>
  <div id="div_main" class="register-wrapper ">
          ...
          <ul>
            <li>
              ...
              <div class="crm-register-input-warpper">
                <input type="text" class="crm-register-input user_name" name="loginusername" placeholder="请输入手机号／邮箱" tabindex="1" autocomplete="off">
                <span class="login_box_delete" style="display: inline;"><i></i></span>
              </div>
              <!--<span class="errorinfo error_1 ">请您输入用户名</span>-->
              <!--<span class="errorinfo error_1 ">用户名格式不正确,请输入正确格式的用户名</span>-->
            </li>
            <li>
              <div class="crm-register-input-warpper">
                <input class="crm-register-input user_pwd" type="password" placeholder="请输入密码" tabindex="2" autocomplete="off">
                <span class="crm-register-verification dinline-block" style="">
                  <a href="/global/password-forget.action" act="pwd_forget" tabindex="4" style="display:block;">忘记密码？</a>
                </span>
              </div>
              <span class="errorinfo error_2"></span>
            </li>
          </ul>
        </div>
        <div class="crm-register-footer">
          <a href="javascript:;" class="pg-btn-submit dinline-block " tabindex="3" act="login_btn">登     录</a>
        </div>

      </div>
    </div>

    <a href="http://www.xiaoshouyi.com"><div class="bottom-logo"></div></a>

    <div class="crm-register-container">
        没有账号?<a href="#" class="register_link" tabindex="6" act="reg_link" @click.prevent="">免费注册</a>
    </div>
