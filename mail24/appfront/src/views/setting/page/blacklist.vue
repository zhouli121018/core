<template>
  <div class="j-module-content j-maillist mllist-list height100 ">
    ...
    <el-alert :title="plang.SETTING_BLACK_DESC" type="success" :closable="false"></el-alert>
    ...
    <section class="content content-list height100" style="background-color: #fff;background: rgba(255,255,255,0.9);padding-bottom: 13px;" v-loading="listLoading">
      ...
      <el-row class="toolbar">
        ...
        <el-col :span="12" >
          <el-pagination layout="total, sizes, prev, slot, next, jumper" @size-change="f_TableSizeChange" @current-change="f_TableCurrentChange"  :page-sizes="[10, 20, 50, 100]" :current-page.sync="page" :page-size.sync="page_size" v-if="total>0" :total="total" style="float: right">
