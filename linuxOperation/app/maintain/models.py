...
class AccountTransfer(models.Model):
    ...
    succ_del = models.IntegerField(_(u'迁移后删除帐号'), choices=choices.ACCOUNT_TRANSFER_DEL, null=False, blank=False, default=-1,
                                   help_text=u"可选择是否保留原邮箱帐号。迁移完成后，勾选的邮件、网盘、通讯录选项所对应的数据会被删除。")
...
class POP3Moving(models.Model):
    ...
    disabled = models.CharField(u'激活状态', max_length=2, choices=choices.ACCOUNT_IMAPMOVING_DISABLE, null=False, blank=False, default="-1")
