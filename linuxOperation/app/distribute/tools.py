...
def is_distribute_open():
    from app.distribute.models import ProxyServerConfig
    obj = ProxyServerConfig.objects.filter(config_name=u"proxy_open").first()
    return True if (obj and str(obj.config_data)=="1") else False
