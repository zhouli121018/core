<template>
    <div class="m-mlwelcome">
                <div class="container">
                    <div class="header">
                        <div class="panel-sbj"><div class="tag skin-primary-bg"></div>下午好, oadmin@business1473.com</div>
                        <div class="panel-cnt">
                            <div class="abstract">
                                <div class="avatar">
                            ...
                            <div class="weather">
                                <div class="weadesc">
                                    <div class="temp">33 ~ 25℃</div>
                                    <span>多云/无持续风向微风</span>
                        ...
                        <div class="bulletins">
                            ...
                            <div class="panel-cnt">
                                <div class="content">
                                    ...
                                    <p>
                                        <a href="http://www.lunkr.cn/" class="lunkr_image" target="_blank" title="了解Coremail论客" style="display: block;width: 100%;height: 266px;background-size: cover;background-repeat:no-repeat;"></a>
                                    </p>
